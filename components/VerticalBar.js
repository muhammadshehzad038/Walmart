  ...
  return (
    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{flexDirection:'row'}}>
        <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/bycyle.webp')} style={Styles.img}/>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/bed.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20,backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/lcd.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20, backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
            <Text style={Styles.txt}>Now $134.99 </Text>
            <Text style={Styles.txt3}> $299.99 </Text>
            <Text style={Styles.txt2}>CRUA 27"</Text>
            <Text style={Styles.txt2}>144Hz/165Hz...</Text>
            <TouchableOpacity style={Styles.btn}>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/mus.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20, backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/bed1.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20, backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/mens.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20, backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/car.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20, backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/chair.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20, backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/cy.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20, backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
            <Text style={Styles.txt}>Now $674.99 </Text>
            ...
            <View style={{marginTop:5,padding:10}}>
            <Image source={require('../assests/cq.webp')} style={Styles.img}/>
            <TouchableOpacity style={{position:'absolute', right:20 , top:20, backgroundColor:'white',borderRadius:14}}>
             <Entypo name="heart-outlined" size={24} color="black" /> 
            </TouchableOpacity>
